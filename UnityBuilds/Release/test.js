    ...
    return function e(t, n, o) {
        ...
        7: [function(e, t, n) {
            ...
            t.exports = function(e, t) {
                var n, a, r, s, l, d, u, c, f, h, m, p, w, b, g, v, k, y, _, x, S, M, C, E, R;
                n = e.state,
                a = e.next_in,
                E = e.input,
                r = a + (e.avail_in - 5),
        ...
        8: [function(e, t, n) {
            ...
            function a(e) {
                ...
                t.distcode = t.distdyn = new b.Buf32(pe),
                t.sane = 1,
                t.back = -1,
                R) : L
            }
            ...
            function c(e, t, n, o) {
                ...
                o >= a.wsize ? (b.arraySet(a.window, t, n - a.wsize, a.wsize, 0),
                a.wnext = 0,
                a.whave = a.wsize) : (i = a.wsize - a.wnext,
                i > o && (i = o),
                b.arraySet(a.window, t, n - o, i, a.wnext),
                o -= i,
                o ? (b.arraySet(a.window, t, n - o, o, 0),
                a.wnext = o,
            ...
            function f(e, t) {
                var n, i, a, r, s, l, d, f, h, m, p, w, me, pe, we, be, ge, ve, ke, ye, _e, xe, Se, Me, Ce = 0, Ee = new b.Buf8(4), Re = [16, 17, 18, 0, 8, 7, 9, 6, 10, 5, 11, 4, 12, 3, 13, 2, 14, 1, 15];
                ...
                e: for (; ; )
                    ...
                    case T:
                        ...
                        n.mode = N;
                    case N:
                        if (1024 & n.flags && (w = n.length,
                        w > l && (w = l),
                        w && (n.head && (_e = n.head.extra_len - n.length,
                    ...
                    case q:
                        if (2048 & n.flags) {
                            ...
                            while (_e && l > w);if (512 & n.flags && (n.check = v(n.check, i, w, r)),
                            l -= w,
                            r += w,
                            _e)
                                break e
            ...
            var p, w, b = e("../utils/common"), g = e("./adler32"), v = e("./crc32"), k = e("./inffast"), y = e("./inftrees"), _ = 0, x = 1, S = 2, M = 4, C = 5, E = 6, R = 0, F = 1, D = 2, L = -2, B = -3, A = -4, U = -5, z = 8, I = 1, O = 2, Z = 3, P = 4, T = 5, N = 6, q = 7, G = 8, j = 9, H = 10, W = 11, J = 12, K = 13, Y = 14, X = 15, V = 16, Q = 17, $ = 18, ee = 19, te = 20, ne = 21, oe = 22, ie = 23, ae = 24, re = 25, se = 26, le = 27, de = 28, ue = 29, ce = 30, fe = 31, he = 32, me = 852, pe = 592, we = 15, be = we, ge = !0;
            n.inflateReset = r,
            n.inflateReset2 = s,
        ...
        9: [function(e, t, n) {
            ...
            t.exports = function(e, t, n, m, p, w, b, g) {
                var v, k, y, _, x, S, M, C, E, R = g.bits, F = 0, D = 0, L = 0, B = 0, A = 0, U = 0, z = 0, I = 0, O = 0, Z = 0, P = null , T = 0, N = new o.Buf16(i + 1), q = new o.Buf16(i + 1), G = null , j = 0;
                for (F = 0; i >= F; F++)
                    N[F] = 0;
                for (D = 0; m > D; D++)
                    N[t[n + D]]++;
                ...
                for (var H = 0; ; ) {
                    ...
                    do
                        k -= v,
                        p[x + (Z >> z) + k] = M << 24 | C << 16 | E | 0;
                    while (0 !== k);for (v = 1 << F - 1; Z & v; )
                        v >>= 1;
                    if (0 !== v ? (Z &= v - 1,
                    Z += v) : Z = 0,
                    D++,
                ...
                return 0 !== Z && (p[x + Z] = F - z << 24 | 64 << 16 | 0),
                g.bits = A,
                0
            }
        }
        ...
        "/lib/inflate.js": [function(e, t, n) {
            ...
            h.prototype.push = function(e, t) {
                ...
                } while (c.avail_in > 0 && n !== l.Z_STREAM_END);return n === l.Z_STREAM_END && (o = l.Z_FINISH),
...
function() 
{
    var e = function(e) 
    {
        ...
        function n() {
            ...
            new t(0,1209339,0,0).open("GET", "/data.unity3d"),
            new t(1209339,1209520,0,0).open("GET", "/methods_pointedto_by_uievents.xml"),
            new t(1209520,2746824,0,0).open("GET", "/Il2CppData/Metadata/global-metadata.dat"),
            new t(2746824,4243516,0,0).open("GET", "/Resources/unity_default_resources"),
            new t(4243516,4271142,0,0).open("GET", "/Managed/mono/2.0/machine.config"),
